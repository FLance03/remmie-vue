<template>
  <info-table v-on:changePage="changePage($event)" v-bind:pageNumbers="pageNumbers" v-bind:page="currentPage" v-bind:heads="tableHead" v-bind:infos="tableData"></info-table>
</template>
